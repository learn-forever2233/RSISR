...
from basicsr.data.online_degradation import online_degradation
...
class PairedImageDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Determine branch based on probability
        use_online_degradation = random.random() < 0.6  # 60% for branch B
        ...
        if self.task == 'CAR':
            ...
            if use_online_degradation:
                # Branch B: Online degradation
                img_lq = online_degradation(img_gt, scale)
                lq_path = gt_path + '_syn'
            else:
                # Branch A: Use paired LQ
