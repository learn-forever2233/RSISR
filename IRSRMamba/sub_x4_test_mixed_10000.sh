...
#SBATCH --job-name=LR_test_mixed_10000 # 作业名称
...
# 3. 执行测试任务
echo "开始测试 IRSRMamba 混合训练模型 (4倍超分辨率)"
echo "模型路径：/hpcfs/fhome/competitor01/lhx/IRSRMamba/experiments/finetune_IRSR_x4_mixed/models/net_g_10000.pth"
echo "输入数据：/hpcfs/fhome/competitor01/lhx/IRSRMamba/score/train/val_LR_X4/X4"
echo "输出结果：/hpcfs/fhome/competitor01/lhx/IRSRMamba/results/IRSR_finetune_mixed_10000/visualization"
export PYTHONPATH=/hpcfs/fhome/competitor01/lhx/IRSRMamba:$PYTHONPATH
python basicsr/test.py -opt options/test/test_IRSR_mixed_10000.yml
