...
#SBATCH --job-name=LR_test_x4_val # 作业名称
...
# 3. 执行训练任务
echo "开始测试 IRSRMamba 模型 (4倍超分辨率)"
export PYTHONPATH=$PYTHONPATH:/hpcfs/fhome/competitor01/IRSRMamba
python basicsr/test.py -opt options/test/test_IRSRMamba_x4_lr_only_val.yml
