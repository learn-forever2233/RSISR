...
#SBATCH --job-name=IRSR_test_15000_5137 # 作业名称
...
echo "模型路径：/hpcfs/fhome/competitor01/lhx/IRSRMamba/net_g_15000.pth"
echo "输入数据：/hpcfs/fhome/competitor01/lhx/IRSRMamba/score/train/val_LR_X4/X4"
echo "输出结果：/hpcfs/fhome/competitor01/lhx/IRSRMamba/results/IRSR_ft_15000/visualization"
export PYTHONPATH=/hpcfs/fhome/competitor01/lhx/IRSRMamba:$PYTHONPATH
python basicsr/test.py -opt options/test/test_IRSR_ft_15000_5139.yml
