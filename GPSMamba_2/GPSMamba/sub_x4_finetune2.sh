...
#SBATCH --job-name=finetune2_GPS_x4 # 作业名称
...
# 3. 执行第二轮微调训练任务
echo "开始第二轮微调训练 GPSMamba 模型 (4倍超分辨率)"
echo "使用预训练权重: /hpcfs/fhome/competitor01/lhx/GPSMamba_2/GPSMamba/experiments/finetune_GPS_x4/models/net_g_65000.pth"
python basicsr/train.py -opt options/train/finetune2_GPS_x4.yml
