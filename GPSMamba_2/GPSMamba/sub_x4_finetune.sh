...
#SBATCH --job-name=finetune_GPS_x4 # 作业名称
...
# 3. 执行微调训练任务
echo "开始微调训练 GPSMamba 模型 (4倍超分辨率)"
echo "使用预训练权重: /hpcfs/fhome/competitor01/lhx/GPSMamba_2/net_g_x4_best.pth"
python basicsr/train.py -opt options/train/finetune_GPS_x4.yml
